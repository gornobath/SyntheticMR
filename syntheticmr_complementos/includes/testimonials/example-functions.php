 ...
 */
function arg_perfileria_show_if_front_page( $cmb ) {
 ...
 * @return bool              True if metabox should show
 */
function arg_perfileria_hide_if_no_cats( $field ) {
 ...
 */
function arg_perfileria_render_row_cb( $field_args, $field ) {
 ...
 * @param  CMB2_Field $field      The field object.
 */
function arg_perfileria_display_text_small_column( $field_args, $field ) {
	?>
 ...
 * @param  CMB2_Field $field      Field object.
 */
function arg_perfileria_before_row_if_2( $field_args, $field ) {
 ...
 */
function arg_perfileria_register_demo_metabox() {
	/**
 ...
 */
function arg_perfileria_register_about_page_metabox() {
 ...
 */
function arg_perfileria_register_repeatable_group_field_metabox() {
 ...
 */
function arg_perfileria_register_user_profile_metabox() {
 ...
 */
function arg_perfileria_register_taxonomy_metabox() {
 ...
 */
function arg_perfileria_register_theme_options_metabox() {
 ...
 * }
 */
function arg_perfileria_options_page_message_callback( $cmb, $args ) {
 ...
 */
function arg_perfileria_limit_rest_view_to_logged_in_users( $is_allowed, $cmb_controller ) {
 ...
 */
function arg_perfileria_register_rest_api_box() {
